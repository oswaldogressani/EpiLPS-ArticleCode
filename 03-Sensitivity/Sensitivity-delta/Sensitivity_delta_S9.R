...
Rpriors <- matrix(0, nrow = 6, ncol = 53)
...
png(file = "Sensitivity_delta_Scenario9.png", width = 1300, height = 900)
...
legend("topright", c("Target", "a_delta=5, b_delta=5","a_delta=10, b_delta=10",
       ...
       col=c("black","blue","orange","firebrick","darkolivegreen4",
             "mediumorchid","gray"),
       lty=c(2,1,1,1,1,1,1), cex = 1.5, bty = "n", y.intersp = 1)
dev.off()
...
tdiscr <- seq(8, 60)
Rtarget <- sapply(tdom, simepidemic$Rtrue)
pdf(file = "Sensitivity_delta_Scenario9.pdf", width = 13.5, height = 7)
par(mar = c(5.1, 4.1, 4.1, 2.1) + 0.3)
plot(tdom, Rtarget, type = "l", col = "black", ylab="R(t)", xlab="Time (days)",
...
legend("topright", c("Target", "a_delta=5, b_delta=5","a_delta=10, b_delta=10",
       ...
       col=c("black","blue","orange","firebrick","darkolivegreen4",
             "mediumorchid","gray"),
       lty=c(2,1,1,1,1,1,1), cex = 1.3, bty = "n", y.intersp = 0.9)
dev.off()
...
pdf(file = "Sensitivity_CI_Scenario9.pdf", width = 15, height = 21)

par(mfrow = c(2,1))

# P1: a_delta=5; b_delta=5
plot(seq(1,33),RCIlowa5[1,], type="p", ylim = c(0,5), col="darkolivegreen",
     pch = 0, main = "Sensitivity of 90% CI lower bound (Scenario 9)", 
...
plot(seq(1,33),RCIupa5[1,], type="p", ylim = c(0,7.5), col="darkolivegreen", 
     pch = 0, main = "Sensitivity of 90% CI upper bound (Scenario 9)", 
